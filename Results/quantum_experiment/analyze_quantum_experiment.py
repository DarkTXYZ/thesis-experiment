...
def analyze_results(file_path):
    ...
    for sampler in sorted(df['solver'].unique()):
        ...
        print("-"*80)
        print(f"{'n':<5} {'Graphs':<8} {'Feasible':<12} {'Feas. Rate':<12} {'Avg Ratio':<12} {'Avg Time':<10}")
        print("-"*80)
        ...
        for n in sorted(df_sampler['n'].unique()):
            ...
            print(f"{n:<5} {num_graphs:<8} {num_feasible}/{num_graphs:<6} {feasibility_rate:>10.1f}% {ratio_str:<12} {time_str:<10}")
...
if __name__ == "__main__":
    file_path = 'Results/quantum_experiment/quantum_experiment_linear_20260401_085012.csv'

...
def add_optimal_costs():
    """Add optimal costs to existing pkl files using CP-SAT solver."""
    pkl_files = sorted(
        f for f in os.listdir(SCRIPT_DIR)
        if f.startswith("quantum_n") and f.endswith(".pkl")
    )
...
def generate():
    ...
    save_graphs_to_pickle(num_vertices_list, num_graphs, density, seed, output_dir)
